"""36氪适配器 — 通过官方 RSS feed 获取最新科技商业资讯。"""
...
class Kr36Adapter(BaseAdapter):
    ...
    def __init__(self) -> None:
        self.limit = int(os.environ.get("KR36_LIMIT", _DEFAULT_LIMIT))
        self.max_age_days = int(os.environ.get("KR36_MAX_AGE_DAYS", _DEFAULT_MAX_AGE_DAYS))
