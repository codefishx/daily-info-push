"""爱范儿适配器 — 通过官方 RSS feed 获取最新消费科技资讯。"""
...
_FEED_URL = "https://www.ifanr.com/feed"
...
class IfanrAdapter(BaseAdapter):
    ...
    def __init__(self) -> None:
        self.limit = int(os.environ.get("IFANR_LIMIT", _DEFAULT_LIMIT))
        self.max_age_days = int(os.environ.get("IFANR_MAX_AGE_DAYS", _DEFAULT_MAX_AGE_DAYS))
