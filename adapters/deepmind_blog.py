"""DeepMind Blog 适配器 — 通过官方 RSS feed 获取最新研究博文。"""
...
_FEED_URL = "https://deepmind.google/blog/rss.xml"
...
class DeepMindBlogAdapter(BaseAdapter):
    ...
    def __init__(self) -> None:
        self.limit = int(os.environ.get("DEEPMIND_LIMIT", _DEFAULT_LIMIT))
        self.max_age_days = int(os.environ.get("DEEPMIND_MAX_AGE_DAYS", _DEFAULT_MAX_AGE_DAYS))
    ...
    def _to_raw_item(entry, published_at: datetime | None) -> RawItem:
        ...
        return RawItem(
            id=DeepMindBlogAdapter._make_id(link),
