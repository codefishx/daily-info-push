"""虎嗅适配器 — 通过官方 RSS feed 获取最新科技商业文章。"""
...
_FEED_URL = "https://www.huxiu.com/rss/0.xml"
...
class HuxiuAdapter(BaseAdapter):
    ...
    def __init__(self) -> None:
        self.limit = int(os.environ.get("HUXIU_LIMIT", _DEFAULT_LIMIT))
        self.max_age_days = int(os.environ.get("HUXIU_MAX_AGE_DAYS", _DEFAULT_MAX_AGE_DAYS))
