"""界面新闻适配器 — 通过 FeedX RSS 获取最新财经商业资讯。"""
...
_FEED_URL = "https://feedx.net/rss/jiemian.xml"
...
class JiemianAdapter(BaseAdapter):
    ...
    def __init__(self) -> None:
        self.limit = int(os.environ.get("JIEMIAN_LIMIT", _DEFAULT_LIMIT))
        self.max_age_days = int(os.environ.get("JIEMIAN_MAX_AGE_DAYS", _DEFAULT_MAX_AGE_DAYS))
    ...
    def _to_raw_item(entry, published_at: datetime | None) -> RawItem:
        ...
        return RawItem(
            id=JiemianAdapter._make_id(link),
            source_name="界面新闻",
            source_type="News",
