"""Nautilus Magazine 适配器 — 通过 RSS feed 获取深度科学文章。"""
...
_FEED_URL = "https://nautil.us/feed/"
...
class NautilusAdapter(BaseAdapter):
    ...
    def __init__(self) -> None:
        self.limit = int(os.environ.get("NAUTILUS_LIMIT", _DEFAULT_LIMIT))
        self.max_age_days = int(os.environ.get("NAUTILUS_MAX_AGE_DAYS", _DEFAULT_MAX_AGE_DAYS))
    ...
    def _to_raw_item(entry, published_at: datetime | None) -> RawItem:
        ...
        return RawItem(
            id=NautilusAdapter._make_id(link),
