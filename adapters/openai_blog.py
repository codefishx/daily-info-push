"""OpenAI Blog 适配器 — 通过官方 RSS feed 获取最新博文。"""
...
_FEED_URL = "https://openai.com/blog/rss.xml"
...
class OpenAIBlogAdapter(BaseAdapter):
    ...
    def __init__(self) -> None:
        self.limit = int(os.environ.get("OPENAI_BLOG_LIMIT", _DEFAULT_LIMIT))
        self.max_age_days = int(os.environ.get("OPENAI_BLOG_MAX_AGE_DAYS", _DEFAULT_MAX_AGE_DAYS))
    ...
    def _to_raw_item(entry, published_at: datetime | None) -> RawItem:
        ...
        return RawItem(
            id=OpenAIBlogAdapter._make_id(link),
