"""TechCrunch 适配器 — 通过 RSS feed 获取最新科技创业新闻。"""
...
class TechCrunchAdapter(BaseAdapter):
    ...
    def __init__(self) -> None:
        self.limit = int(os.environ.get("TECHCRUNCH_LIMIT", _DEFAULT_LIMIT))
        self.max_age_days = int(os.environ.get("TECHCRUNCH_MAX_AGE_DAYS", _DEFAULT_MAX_AGE_DAYS))
    ...
    def _to_raw_item(entry, published_at: datetime | None) -> RawItem:
        ...
        return RawItem(
            id=TechCrunchAdapter._make_id(link),
