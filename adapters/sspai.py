"""少数派 (sspai) 适配器 — 通过官方 RSS feed 获取最新数字生活文章。"""
...
_FEED_URL = "https://sspai.com/feed"
...
class SspaiAdapter(BaseAdapter):
    ...
    def __init__(self) -> None:
        self.limit = int(os.environ.get("SSPAI_LIMIT", _DEFAULT_LIMIT))
        self.max_age_days = int(os.environ.get("SSPAI_MAX_AGE_DAYS", _DEFAULT_MAX_AGE_DAYS))
